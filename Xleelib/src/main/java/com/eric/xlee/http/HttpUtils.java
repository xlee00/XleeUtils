package com.eric.xlee.http;

import android.content.Context;
import android.net.wifi.WifiInfo;
import android.net.wifi.WifiManager;

import com.eric.xlee.network.NetWorkHelper;
import com.eric.xlee.util.CMDExecute;
...
public class HttpUtils {
    ...
    public static String get_user_mac(Context context) {
        ...
        if (u_mac == null || u_mac.length() != 17) {
            ...
            // LogUtil.i("loacal=="+u_mac);
        }
        if (u_mac == null || u_mac.length() != 17) {
            u_mac = fetch_mac_wlan();
            // LogUtil.i("fetch_mac_wlan=="+u_mac);
        }
        if (u_mac != null) {
            return u_mac.trim();
        }
